    ...
    $.fn.jquizzy = function (settings) {
        ...
        superContainer.find('.final').click(function () {
            ...
            if (scoreItems[0] == score2) {
                learPattern = "多血质";
            } else if (scoreItems[0] == score1) {
                learPattern = "胆汁质";
            } else if (scoreItems[0] == score3) {
                learPattern = "粘液质";
            } else if (scoreItems[0] == score4) {
                learPattern = " 抑郁质";
            }
            ...
            $.ajax({
                ...
                success: function (msg) {
                    //1 分数记录成功
                    if (msg == 1) {
                        resultSet = '<h2 class="qTitle">您已做完问卷,请耐心等待分组结果！</h2>' + resultSet +'<a href="student/Default.aspx">返回首页</a>'+ '<div class="jquizzy-clear"></div>';
