...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="main_hd"><h2>发布任务</h2></div>
        ...
        <form id="form1" runat="server">
            <div>课程：
                <asp:DropDownList ID="cnameList" runat="server" AutoPostBack="True" CssClass="add_input">
                    <asp:ListItem>C语言程序设计</asp:ListItem>
                    <asp:ListItem>网络数据库应用</asp:ListItem>
                </asp:DropDownList>
                班级：
                <asp:DropDownList ID="classname" runat="server" AutoPostBack="True" CssClass="add_input">
            ...
            <div>                
                ...
                <asp:Button ID="date1" runat="server" Text="..." />
                <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#3366CC" 
                BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" 
                ForeColor="#003399" Height="150px" Width="300px" ShowGridLines="true" Visible="False" >
            ...
            <div>
                <asp:Button ID="Submit" runat="server"  Text="发布" 
